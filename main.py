...
def listen(data):
    try:  
        with speech_recognition.Microphone() as mic:
                ...
                print(message)
                intent = rasaint(message)[0]['name']
                confidence = rasaint(message)[0]['confidence']
                print(confidence)
                if( intent =='nlu_fallback' or confidence < 0.9 ):
                    ga(message)
                else:
                    print(intent)
                    print(rasatext(message))
                    say(rasatext(message))
